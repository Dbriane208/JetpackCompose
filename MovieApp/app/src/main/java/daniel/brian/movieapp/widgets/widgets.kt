package daniel.brian.movieapp.widgets
...
@Preview
@Composable
// we're initializing the onItemClick to make it optional to  pass its parameter
    ...
    Card(modifier = Modifier
        ...
        Row (verticalAlignment = Alignment.CenterVertically,
            ...
            Surface (modifier = Modifier
                ...
                // using images from our data model
                    AsyncImage(
            ...
            Column(modifier = Modifier.padding(4.dp)) {
                ...
                // creating Animated visibility
                AnimatedVisibility(visible = expanded) {
                    Column(modifier = Modifier) {
                        // the text annotated string can be used to
                        // alter the color and style of certain selected colors
                        Text(
                        ...
                        // creating a line between the plot and the other information
